"""
This script provides two methods to solve a First-order linear ODE with terminal condition
...
def solver_integrating_factor_fast_initial_condition():
